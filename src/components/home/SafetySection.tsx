...
export const risks = [
  ...
  { risk: "Spam calls", answer: "Secure In Bound Chat instead of exposed phone numbers." },
    ...
    <section className="bg-navy py-20 text-navy-foreground" aria-labelledby="safety-heading">
      <div className="container-page">
        <SectionHeading
          ...
          subtitle="Common rental risks, and the specific way In Bound addresses each one."
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {risks.map((r) => (
            ...
            >
              ...
              <p className="mt-1 text-xs uppercase tracking-wider text-primary">In Bound answer</p>
