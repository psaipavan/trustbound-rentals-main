...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact In Bound" },
      {
        name: "description",
        content:
          "Questions about listings, verification, agents or partnerships? Send the In Bound team a message.",
      },
      { property: "og:title", content: "Contact In Bound" },
